...
void loop() {  
  ...
  height = u8g2_for_arduino_gfx.getFontAscent() - u8g2_for_arduino_gfx.getFontDescent();
  width = u8g2_for_arduino_gfx.getUTF8Width(s);/* draw the box around the text*/
  gfx->drawRect(x, y-u8g2_for_arduino_gfx.getFontAscent(), width, height, WHITE);// make everything visible
  delay(2000);
} 
